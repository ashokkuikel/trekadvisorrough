				...
				<div class="col-sm-8">
					...
					<form action="${pageContext.request.contextPath}/updatePost"
						...
						<div class="form-group">
							...
							<input type="hidden" class="form-control" value="${post.post_id}"
								name="post_id" readonly>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="post_description">Description</label> <input
								type="text" rows="5" class="form-control"
								value="${post.post_description}" name="post_description">
						</div>


						<div class="form-group">
							<label for="post_category">Category</label> <input type="text"
								class="form-control" value="${post.post_category}"
								name="post_category" />
						</div>

						<div class="form-group">
							<label for="password">Password</label> <input type="text"
								class="form-control" value="${post.post_price}"
